 ...
 */
export class ActorDetachmentSheet extends ActorSheet {
  ...
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      ...
      template: 'systems/w40k/templates/actor-detachment-sheet.html',
      width: 800,
      height: 960,
      tabs: [
  ...
  activateListeners(html) {
    ...
    html.find('.weapon.rollable').click(ev => {
      ...
      let template = 'systems/w40k/templates/chat/action-card.html';
